...
- Diretriz estratégica atual: **não é prioridade evoluir boost para subir preço diretamente**; a prioridade é fechar o ciclo econômico real com fluxo R$ → RPC → token/projeto, recompra real, reserva e distribuição auditável se mantida.
